...
const schulteOrderCards: SchulteOrderCard[] = [
  ...
  },
  {
    ...
    explanation: {
      title: 'Ten across a wider board',
      body: 'On a 4×3 board with two empty cells, keep your gaze near the middle and let each next number come to you rather than scanning row by row.',
    },
    config: {
      rows: 4,
      columns: 3,
      targets: [
        { id: 's1', label: '1', row: 1, column: 2 },
