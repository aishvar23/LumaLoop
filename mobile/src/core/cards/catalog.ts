...
const spotItCards: SpotItCard[] = [
  ...
  },
  {
    ...
    reviewStatus: 'manual_reviewed',
    estimatedSeconds: 18,
    prompt: 'The board is all 5s — except one S. Tap the S.',
    puzzleDna: {
      mechanic: 'visual-search',
      inputMode: 'tap',
      measuredSignals: ['accuracy', 'reaction_time'],
  ...
  },
  {
    ...
    reviewStatus: 'manual_reviewed',
    estimatedSeconds: 22,
    prompt: 'A field of down-left arrows hides one left arrow. Tap the left arrow.',
    puzzleDna: {
      mechanic: 'visual-search',
      inputMode: 'tap',
      measuredSignals: ['reaction_time', 'accuracy'],
  ...
  },
  {
    ...
    reviewStatus: 'manual_reviewed',
    estimatedSeconds: 24,
    prompt: 'Every O hides one tailed Q on a big board. Tap the Q.',
    puzzleDna: {
      mechanic: 'visual-search',
      inputMode: 'tap',
      measuredSignals: ['accuracy', 'reaction_time'],
    ...
    explanation: {
      title: 'Tail on a bigger field',
      body: 'A Q is an O with a tiny tail. On a 7×8 board there are 55 distractors, so the only reliable move is to sweep for that single extra stroke at row 6, column 2.',
    },
    shareText: 'Found the lone Q on a 56-cell board.',
    config: {
      rows: 7,
      columns: 8,
      baseElement: 'O',
  ...
  },
  {
    ...
    reviewStatus: 'manual_reviewed',
    estimatedSeconds: 18,
    prompt: 'The grid is filled with 0 — except one O. Tap the letter O.',
    puzzleDna: {
      mechanic: 'visual-search',
      inputMode: 'tap',
      measuredSignals: ['accuracy', 'reaction_time'],
    ...
    explanation: {
      ...
      body: 'A zero 0 is tall and narrow; the letter O is rounder and wider. The difference is subtle, so compare widths — the O sits in row 4, column 3.',
    },
    config: {
      rows: 6,
      columns: 6,
  ...
  },
  {
    ...
    reviewStatus: 'manual_reviewed',
    estimatedSeconds: 18,
    prompt: 'Among the up-triangles, one points down. Tap the down-triangle.',
    puzzleDna: {
      mechanic: 'visual-search',
      inputMode: 'tap',
      measuredSignals: ['reaction_time', 'accuracy'],
  ...
  },
  {
    ...
    reviewStatus: 'manual_reviewed',
    estimatedSeconds: 24,
    prompt: 'A wall of lowercase l hides one capital I. Tap the I.',
    puzzleDna: {
      mechanic: 'visual-search',
      inputMode: 'tap',
      measuredSignals: ['accuracy', 'reaction_time'],
    ...
    explanation: {
      title: 'Near-identical strokes',
      body: 'A lowercase l and a capital I are both vertical bars — the I is often a touch shorter and squarer at the ends. This near-twin pairing is what makes it hard; the I is at row 7, column 4.',
    },
    shareText: 'Picked the capital I from a wall of lowercase l.',
    config: {
      rows: 7,
      columns: 7,
      baseElement: 'l',
  ...
  },
  {
    ...
    reviewStatus: 'manual_reviewed',
    estimatedSeconds: 22,
    prompt: 'Hearts fill the board — one is a spade. Tap the spade.',
    puzzleDna: {
      mechanic: 'visual-search',
      inputMode: 'tap',
      measuredSignals: ['reaction_time', 'accuracy'],
    ...
    explanation: {
      title: 'Lobes up or down',
      body: 'A heart ♥ has its two lobes at the top; a spade ♠ flips that — lobes at the bottom, point up, with a stem. The spade hides in row 6, column 7.',
    },
    config: {
      rows: 7,
      columns: 8,
...
const whatChangedCards: WhatChangedCard[] = [
  ...
  },
  {
    ...
    explanation: {
      ...
      body: 'The sixth symbol changed from a club ♣ to a heart ♥. The heart is the only shape that was absent from the original row, even though the row is busy with seven suits.',
    },
    config: {
      previewMs: 4500,
      timeLimitMs: 18000,
...
const tinyLogicCards: TinyLogicCard[] = [
  ...
  },
  {
    ...
    reviewStatus: 'manual_reviewed',
    estimatedSeconds: 24,
    prompt: 'Two operations alternate. Find the next number.',
    puzzleDna: {
      mechanic: 'sequence-extrapolation',
      inputMode: 'choice',
      measuredSignals: ['accuracy', 'reaction_time'],
  ...
  },
  {
    ...
    reviewStatus: 'manual_reviewed',
    estimatedSeconds: 24,
    prompt: 'Two sequences are interleaved. Find the next number.',
    puzzleDna: {
      mechanic: 'sequence-extrapolation',
      inputMode: 'choice',
      measuredSignals: ['accuracy', 'reaction_time'],
  ...
  },
  {
    ...
    reviewStatus: 'manual_reviewed',
    estimatedSeconds: 18,
    prompt: 'Work out the rule on the letters, then pick what comes next.',
    puzzleDna: {
      mechanic: 'sequence-extrapolation',
      inputMode: 'choice',
      measuredSignals: ['accuracy', 'reaction_time'],
...
const patternChainCards: PatternChainCard[] = [
  ...
  },
  {
    ...
    reviewStatus: 'manual_reviewed',
    estimatedSeconds: 18,
    prompt: 'The gaps grow by one each step. Pick the next two numbers.',
    puzzleDna: {
      mechanic: 'sequence-continuation',
      inputMode: 'choice',
      measuredSignals: ['accuracy', 'pattern_extension'],
  ...
  },
  {
    ...
    reviewStatus: 'manual_reviewed',
    estimatedSeconds: 28,
    prompt: 'A letter and a number step together. Pick the next three items.',
    puzzleDna: {
      mechanic: 'sequence-continuation',
      inputMode: 'choice',
      measuredSignals: ['accuracy', 'pattern_extension'],
  ...
  },
  {
    ...
    reviewStatus: 'manual_reviewed',
    estimatedSeconds: 30,
    prompt: 'A shape rotates while its count climbs. Pick the next four steps.',
    puzzleDna: {
      mechanic: 'sequence-continuation',
      inputMode: 'choice',
      measuredSignals: ['accuracy', 'pattern_extension'],
  ...
  },
  {
    ...
    reviewStatus: 'manual_reviewed',
    estimatedSeconds: 30,
    prompt: 'Each term is the previous one times three minus one. Pick the next five.',
    puzzleDna: {
      mechanic: 'sequence-continuation',
      inputMode: 'choice',
      measuredSignals: ['accuracy', 'pattern_extension'],
  ...
  },
  {
    ...
    reviewStatus: 'manual_reviewed',
    estimatedSeconds: 20,
    prompt: 'The squares of the counting numbers. Pick the next two.',
    puzzleDna: {
      mechanic: 'sequence-continuation',
      inputMode: 'choice',
      measuredSignals: ['accuracy', 'pattern_extension'],
  ...
  },
  {
    ...
    reviewStatus: 'manual_reviewed',
    estimatedSeconds: 14,
    prompt: 'The letters skip one each time. Pick the next two.',
    puzzleDna: {
      mechanic: 'sequence-continuation',
      inputMode: 'choice',
      measuredSignals: ['accuracy', 'pattern_extension'],
  ...
  },
  {
    ...
    reviewStatus: 'manual_reviewed',
    estimatedSeconds: 20,
    prompt: 'Two interleaved counts share the row. Pick the next two.',
    puzzleDna: {
      mechanic: 'sequence-continuation',
      inputMode: 'choice',
      measuredSignals: ['accuracy', 'pattern_extension'],
