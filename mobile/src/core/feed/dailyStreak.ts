// Ported from web `src/feed/dailyStreak.ts`; source of truth is the web app — keep
// in sync (daily streak — consecutive-days-played engagement counter).
// Byte-faithful: only this header differs. See `mobile/src/core/README.md`.
/**
