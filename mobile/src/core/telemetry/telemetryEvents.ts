// Ported from web `src/telemetry/telemetryEvents.ts`; source of truth is the web
// app — keep in sync (Phase M, M2). The telemetry CLIENT + `anonymousUser`
// (browser localStorage) are NOT ported — the RN client is M5. See
