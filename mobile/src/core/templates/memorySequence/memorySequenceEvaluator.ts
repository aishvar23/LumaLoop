// Ported from web `src/templates/memorySequence/memorySequenceEvaluator.ts`;
// source of truth is the web app — keep in sync (Phase M, M4). Pure and
// React/DOM-free, so it runs unchanged under React Native.
/**
